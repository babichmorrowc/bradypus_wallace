...
```{r}
output <- spThin::thin(occs, 'latitude', 'longitude', 'name', thin.par = 20, reps = 100, locs.thinned.list.return = TRUE, write.files = FALSE, verbose = FALSE)
```
...
```{r}
projCoords <- data.frame(x = c(-86.4002, -80.3336, -76.2893, -70.1348, -30.4825, -38.9229, -56.0548, -77.1558, -84.3653, -86.4002), y = c(12.2724, 13.9842, 10.2901, 14.3251, -5.2036, -21.8033, -25.3697, -18.694, -6.8892, 12.2724))
