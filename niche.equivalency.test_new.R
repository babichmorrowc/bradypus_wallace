## Modified from the phyloclim package
## original code accessed from https://github.com/cran/phyloclim/blob/master/R/niche.equivalency.test.R
...
niche.equivalency.test_new <- function(p, env, n = 99, app, dir){
